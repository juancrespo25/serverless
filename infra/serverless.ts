    ...
    resources: {
        Resources: {
            CognitoUserPool: {
                ...
                Properties: {
                    UserPoolName: "cognito_user_pool_aws",
            ...
            CognitoUserPoolClient: {
                ...
                Properties: {
                    ClientName: "cognito_user_pool_client_aws",
            ...
            CognitoIdentityPool: {
                ...
                Properties: {
                    IdentityPoolName: "cognito_identity_pool_aws",
            ...
            S3BucketDeploymentLambdas: {
                Type: "AWS::S3::Bucket",
                Properties: {
                    BucketName: "digital-awscurso09-cv-${self:provider.stage}",
                },
            },
            S3BucketMedic: {
                Type: "AWS::S3::Bucket",
                ...
                Properties: {
                    BucketName: "digital-awscurso09-cv-medic-${self:provider.stage}",
                },
            },
            ...
            SQSDLQ: { //cola de mensaes fallidos
                Type: "AWS::SQS::Queue",
                Properties: {
            ...
            AuthenticationTable: {
                Type: "AWS::DynamoDB::Table",
                Properties: {
                    TableName: "AuthenticationCurso-cv-${self:provider.stage}",
                    BillingMode: "PAY_PER_REQUEST",
                    AttributeDefinitions: [
                        {
                            AttributeName: "email",
            ...
            SNSTOPICOCURSO003: {
                ...
                Properties: {
                    ...
                    TopicName: "SNS_TOPICO_CURSO003-${self:provider.stage}",
                }
            },
            SNSToSQSPolicy: {
                Type: "AWS::SQS::QueuePolicy",
                        ...
                        Statement: [
                            {
                                ...
                                Condition: {
                                    ArnEquals: {
                                        "aws:SourceArn": { Ref: "SNSTOPICOCURSO003" },
                                    },
                                },
                            },
                        ],
            ...
            SSMTOPICOSNSNAME: {
                ...
                Properties: {
                    ...
                    Type: "String",
                    Value: { "Fn::GetAtt": ["SNSTOPICOCURSO003", "TopicName"] },
                },
            }
        }
    }
