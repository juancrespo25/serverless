...
export const appointmentHandler = async (event) => {
    ...
    console.log("Appointmen in Peru....");
    console.log(JSON.stringify(event));

    /*Para recibir de un SMS*/
    ...
    for (let record of records) {
        ...
        /*Para recibir de un SQS con un SNS*/
    ...
    return { statusCode: 403, body: "An error occurred while updating Appointment." }
    //return event;
};